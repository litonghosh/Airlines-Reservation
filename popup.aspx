...
<body>
    ...
    <div style="height: 870px">
        ...
        <table class="style1">
            ...
            <tr>
                <td class="style5">
                    <span class="style6">Back to Home page click&nbsp;</span> <a href="Homepage.aspx">
                    <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="Red" 
                        NavigateUrl="~/Homepage.aspx">Here</asp:HyperLink>
                    </a>
    ...
    &nbsp;&nbsp;&nbsp;
                ...
                <td class="style4">
                    &nbsp;&nbsp; &nbsp;</td>
                <td>
                    <span class="style6">Book another Ticket&nbsp;</span> <a href="Homepage.aspx">
